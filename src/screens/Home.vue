...
<template>
  <div class="home-screen p-4">
    ...
    <div class="calender mt-6 flex items-center justify-between">
      ...
      <div class="location flex items-center gap-2 px-4 py-2 border-2 border-solid border-primary rounded-3xl	">
    ...
    <!-- Present Salat Start -->
    <div @click="salatTimeHandler('present')" class="present-salat bg-primary my-3 h-36 relative rounded-2xl">
      ...
      <img src="../assets/images/mosque-bg.png" class="absolute left-0 bottom-0" alt="Mosque Background" >
    </div>
    <!-- Next Salat Start -->
    <div @click="salatTimeHandler('next')" class="next-salat mt-3 px-6 py-4 border border-solid border-green rounded-lg">
    ...
    <div class="tomorrow-schedule bg-chocolate mt-3 h-28 relative rounded-2xl overflow-auto">
      <div class="salat-content w-full px-6 py-3 text-white absolute top-0 left-0 z-10">
      ...
      <img class="absolute bottom-0 left-0" src="../assets/images/mosque-bg-red.png" alt="Mosque Background Red">
    </div>
    <!-- Namaj Option Start -->
    <div class="namaj-options pt-7 grid grid-cols-3 gap-5 gap-y-10">
      <RouterLink to="/salar-schedule" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/mosque.svg" alt="mosque">
        <p class="pt-2 font-light">Salar Schedule</p>
      </RouterLink>
      <RouterLink to="/al-quraan" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/quraan.svg" alt="mosque">
        <p class="pt-2 font-light">Al-Quraan</p>
      </RouterLink>
      <RouterLink to="/sahree-iftar" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/moon.svg" alt="mosque">
        <p class="pt-2 font-light">Sahree - Iftar</p>
      </RouterLink>
      <RouterLink to="/tasbih" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/tasbih.svg" alt="mosque">
        <p class="pt-2 font-light">Tasbih</p>
      </RouterLink>
      <RouterLink to="/kibla-compass" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/teenyicons_compass.svg" alt="mosque">
      ...
      <RouterLink to="/asma-ul-husna" class="option flex flex-col items-center justify-center">
        <img class="w-5 h-5 object-contain object-center" src="../assets/images/icons/asma-ul-husna.png" alt="mosque">
        <p class="pt-2 font-light">Asma-Ul-Husna</p>
      </RouterLink>
    </div>
    <!-- Prohibited Times -->
    <div class="prohibited-times mt-5 px-6 py-6 border-2 border-solid border-primary rounded-lg">
    ...
    <!-- Social Media Start -->
    <div class="social-media mt-3 py-3 px-4 rounded-lg bg-secondary flex items-center justify-between gap-3">
      <img class="w-16" src="../assets/images/logo.svg" alt="social-logo">
      <p class="text-xs text-center">Join our Facebook page to give your original feedback about the app.</p>
      <a href="#" class="bg-primary px-3 py-2 rounded">
