...
<template>
  <the-header title="Tomorrow scheduling">
    <RouterLink to="/loaction" class="location flex items-center gap-1 px-3 py-1 border-2 border-solid border-primary rounded-3xl	">
